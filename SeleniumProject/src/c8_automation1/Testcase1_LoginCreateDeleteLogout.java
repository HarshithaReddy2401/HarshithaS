...
public class Testcase1_LoginCreateDeleteLogout {
    ...
    public static void testScript() {
        ...
        try {
            ...
            oBrowser.findElement(By.id("username")).sendKeys("aa");
            oBrowser.findElement(By.name("pwd")).sendKeys("aa@12");
