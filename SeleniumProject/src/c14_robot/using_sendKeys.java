...
public class using_sendKeys {
    ...
    public static void uploadResumeInNaukri(){
        ...
        try{
            ...
            oBrowser.findElement(By.xpath("//input[@id='email']")).sendKeys("sgTestinghs1@sg.com");
            ...
            oBrowser.findElement(By.xpath("//input[@id='resumeUpload']")).sendKeys("D:\\Morning\\CoreJava\\MyResume.docx");
