...
/*(d) using and logical operator
        syntax:
//<tagName>[@<attrName>='<attrValue>' and @<attrName>='<attrValue>']
        Q: Enter value for first username?
        Ans:
//input[@id='frm1_un_id' and @type='text']
//input[@name='frm1_un_name' and @placeholder='Enter UserName']*/

import org.openqa.selenium.By;
import org.openqa.selenium.chrome.ChromeDriver;

public class Rxpath4_andLogicalOperator {
    public static void main(String[] args) {
        rxpathAndLogicalOperator();
    }

    public static void rxpathAndLogicalOperator(){
